 ...
 * @version 1.0
 */
public class BpcRev extends TCGMEntity implements Serializable
{
	/**
	 ...
	 * know which rows have been selected on the BpcRev maintenance pages.  It was the least code intensive
