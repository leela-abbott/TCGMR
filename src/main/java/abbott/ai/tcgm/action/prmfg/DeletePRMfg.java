 ...
 * @version 1.0
 */
public class DeletePRMfg extends TCGMAction
{
	/**
	 * Default Constructor
	 */
	...
	public ActionForward perform(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response)throws IOException, ServletException
	{
		...
		else if(this.isSessionValid(request))
		{
			...
			try
			{
				prMfgMngr.deletePRMfg(userToken,prMfgForm.getPrmfglist());
				prMfgForm.setPrMfgToEdit(new PRMfg());
			...
			catch(TCGMException tcgme)
			{
				...
				//this.errors.add(ActionErrors.GLOBAL_ERROR,new ActionError("exception.prmfg.delete"));
