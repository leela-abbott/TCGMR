 ...
 * @version 1.0
 */
public class AsrTranSave extends TCGMAction
{
	/**
	 * Default Constructor
	 */
	...
	public ActionForward perform(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response)throws IOException, ServletException
	{
		...
		else if(this.isSessionValid(request))
		{
			...
			if(this.isModelSelected(request))
			{
				...
				AsrTranForm asrTranForm = (AsrTranForm)form;
				...
				try
				{
					...
					**************************************************************/
					...
					if(asrTranForm.getCmd().equals(TCGMConstants.URL_PARM_VAL_ADD) )
					{
						duplicate = asrMngr.addNewAsrTran(userToken,asrTranForm.getAddNew());
					}
					else if(asrTranForm.getCmd().equals(TCGMConstants.URL_PARM_VAL_SAVE_SELECTED) )
					{
						asrMngr.saveSelectedAsrTran(userToken,asrTranForm.getAsrTranList());
					}
					else if(asrTranForm.getCmd().equals(TCGMConstants.URL_PARM_VAL_MASS_UPDATE))
					{
						asrMngr.massUpdate(userToken,asrTranForm.getSearchObject(),asrTranForm.getAddNew());
					}
					...
					if(duplicate){
					errors.add(ActionErrors.GLOBAL_ERROR,new ActionError("success.asrtran.saved"));
					}
					else{
