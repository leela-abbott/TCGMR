	...
	public ActionForward perform(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response)throws IOException, ServletException
	{
		...
		else if(this.isSessionValid(request))
		{
			...
			if(this.isModelSelected(request))
			{
				...
				if (asrTranForm!=null && asrTranForm.getCmd().equalsIgnoreCase(TCGMConstants.URL_PARM_VAL_ADV_FILTER) )  {
						request.getSession().setAttribute("asrTranAdvFilter", asrTranForm);
						asrTranForm.reset(mapping,request);
				...
				try
				{
					...
					**************************************************************/
					...
					asrTranForm.setModels(modelMngr.getModels(userToken, fm));
