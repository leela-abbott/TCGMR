 ...
 * @version 1.0
 */
public class DeleteCurrencyCode extends TCGMAction
{
	/**
	 * Default Constructor
	 */
	...
	public ActionForward perform(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response)throws IOException, ServletException
	{
		...
		else if(this.isSessionValid(request))
		{
			...
			try
			{
				currencyCodeMngr.deleteCurrencys(userToken,currencyCodeForm.getCurrencylist());
			...
			catch(TCGMException tcgme)
			{
				...
				//this.errors.add(ActionErrors.GLOBAL_ERROR,new ActionError("exception.currency.delete"));
