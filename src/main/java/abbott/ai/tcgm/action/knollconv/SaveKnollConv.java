 ...
 * @version 1.0
 */
public class SaveKnollConv extends TCGMAction
{
	/**
	 * Default Constructor
	 */
	public SaveKnollConv()
	{
		super();
	}
	...
	public ActionForward perform(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response)throws IOException, ServletException
	{
		...
		else if(this.isSessionValid(request))
		{
			...
			try
			{
				knollConvMngr.saveKnollConv(userToken,knollConvForm.getKnollConvToEdit());
			...
			catch(TCGMException tcgme)
			{
				...
				//this.errors.add(ActionErrors.GLOBAL_ERROR,new ActionError("exception.knollconv.save"));
