 ...
 * @version 1.0
 */
public class DeleteRateSet extends TCGMAction
{
	/**
	 * Default Constructor
	 */
	public DeleteRateSet()
	{
		super();
	}
	...
	public ActionForward perform(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response)throws IOException, ServletException
	{
		...
		else if(this.isSessionValid(request))
		{
			...
			try
			{
				datasetMngr.deleteRateSetById(this.getUserToken(request),rateSetForm.getSelectedDatasetTableIdInt());
				this.setForward(TCGMConstants.FORWARD_SUCCESS);
			}
// 4-22-03 Insufficient Privileges was taking me to a blank screen.
//			catch(TCGMException tcgme)
//			{
//				this.logger.error(tcgme.toString(),tcgme);
//				this.errors.add(ActionErrors.GLOBAL_ERROR,new ActionError("exception.mngratesets.delete"));
