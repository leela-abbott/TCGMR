 ...
 * @version 1.0
 */
public class EditSalesType extends TCGMAction
{
	/**
	 * Default Constructor
	 */
	public EditSalesType()
	{
		super();
	}
	...
	public ActionForward perform(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response)throws IOException, ServletException
	{
		...
		else if(this.isSessionValid(request))
		{
			...
			try
			{
				...
				salesTypeForm.setSlsTypeToEdit(salesTypeMngr.getSalesTypeBySlsType(userToken,salesTypeForm.getSearchObject()));
