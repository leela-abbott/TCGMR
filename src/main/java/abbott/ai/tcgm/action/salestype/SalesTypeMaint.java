 ...
 * @version 1.0
 */
public class SalesTypeMaint extends TCGMAction
{
	/**
	 * Default Constructor
	 */
	public SalesTypeMaint()
	{
		super();
	}
	...
	public ActionForward perform(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response)throws IOException, ServletException
	{
		...
		else if(this.isSessionValid(request))
		{
				...
				try
				{
					salesTypeForm.setSlsTypeList(salesTypeMngr.getSalesType(userToken,salesTypeForm.getSearchObject(),salesTypeForm.getSortObject()));
