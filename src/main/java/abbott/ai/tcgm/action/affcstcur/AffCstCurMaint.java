 ...
 * @version 1.0
 */
public class AffCstCurMaint extends TCGMAction
{
	/**
	 * Default Constructor
	 */
	public AffCstCurMaint()
	{
		super();
	}
	...
	public ActionForward perform(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response)throws IOException, ServletException
	{
		...
		else if(this.isSessionValid(request))
		{
				...
				try
				{
					affCstCurForm.setAffCstCurList(affCstCurMngr.getAffCstCur(userToken,affCstCurForm.getSearchObject(),affCstCurForm.getSortObject()));
				...
				catch(TCGMException tcgme)
				{
					...
					//this.errors.add(ActionErrors.GLOBAL_ERROR,new ActionError("exception.affcstcur.maintenance"));
