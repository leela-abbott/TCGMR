...
public class JobPublishFactorChgs implements JavaJob {

	public JobPublishFactorChgs()  {
	}
...
// 11-7-05 Not needed as this job is a Stored Procedure
	...
	public void perform(JobInstance jobInstance) throws TCGMException {
		...
		//rm.publishReportNetReport(modelId, "106");
	}
}