<%! String pageTitle="Notes Maintenance Advanced Filter";%>
...
<table width="690" cellspacing="1">
		...
		<tr>
			...
			<td>
				...
				<a href="javascript:changeCmdAndSubmit(document.notesTranForm,'advFilter');" >
		...
		<tr>
			  ...
			  <td width="184">  
			<nested:textarea name="reportRestriction" property="actionCode" rows="2" cols="50" styleClass="commandOption" />	 </td>
			  <td width="142">&nbsp;</td>
		 </tr>
		<nested:nest property="notes">	
		 <tr>
		...
		<tr>
			  ...
			  <td width="184">  
			<nested:textarea name="reportRestriction" property="publishFlag" rows="2" cols="50" styleClass="commandOption" />	 </td>
			  <td width="142">&nbsp;</td>
		 </tr>	
		<tr>
			  <td height="24"></td><td height="24"></td>			  
