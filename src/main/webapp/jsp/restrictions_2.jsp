	...
	<table width="690" border="0" cellpadding="2">
		...
		<nested:iterate name="mngFactorsForm" property="restrictions" id="reportRestriction" type="abbott.ai.tcgm.entities.ReportRestriction">
			<tr>
			  ...
			  <td height="24" ></td>
			  <td width="145">
			  	<nested:select name="reportRestriction" property="column" styleClass="cmdOpt"><html:options name="columns" /></nested:select>
              </td>
			  <td class="tableEntry" >
			  	IN
			  </td>
			  <td width="184">  
    		  	<nested:textarea name="reportRestriction" property="value" rows="4" cols="25" styleClass="cmdOpt" />				
			  </td>
			  <td width="142">&nbsp;</td>
			</tr>
		</nested:iterate>
