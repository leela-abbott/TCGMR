<%! String pageTitle="Asr Tran Maintenance Advanced Filter";%>
...
<table width="690" cellspacing="1">
		...
		<tr>
			...
			<td>
				...
				<a href="javascript:changeCmdAndSubmit(document.asrTranForm,'advFilter');" >
		...
		<tr>
			  <td height="24"></td><td height="24"></td>			  
			  <td width="145" class="commandOption">Prod Orig </td>
			  <td width="184">  
			<nested:textarea name="reportRestriction" property="productOrigin" rows="1" cols="50" styleClass="commandOption" />	 </td>
			  <td width="142">&nbsp;</td>
		 </tr>		 
		 <tr>
			  <td height="24"></td><td height="24"></td>			  
		...
		<tr>
			  <td height="24"></td><td height="24"></td>			  
			  <td width="145" class="commandOption">Usage Factor </td>
			  <td width="184">  
			<nested:textarea name="reportRestriction" property="usage" rows="1" cols="50" styleClass="commandOption" />	 </td>
			  <td width="142">&nbsp;</td>
		 </tr>
		<tr>
			  <td height="24"></td><td height="24"></td>			  
			  <td width="145" class="commandOption">Sup Key </td>
			  <td width="184">  
			<nested:textarea name="reportRestriction" property="supKey" rows="1" cols="50" styleClass="commandOption" />	 </td>
			  <td width="142">&nbsp;</td>
		 </tr>
	</nested:nest>
		<tr>
