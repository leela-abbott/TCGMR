<%! String pageTitle="Bpc Rev Maintenance Advanced Filter";%>
...
<table width="690" cellspacing="1">
		...
		<tr>
			...
			<td>
				...
				<a href="javascript:changeCmdAndSubmit(document.bpcRevTranForm,'advFilter');" >
		...
		<tr>
		 ...
		 <tr>
			  <td height="24"></td><td height="24"></td>			  
			  <td width="145" class="commandOption">Rev Type </td>
			  <td width="184">  
			<nested:textarea name="reportRestriction" property="revType" rows="1" cols="50" styleClass="commandOption" />	 </td>
			  <td width="142">&nbsp;</td>
		 </tr>		 
		<nested:nest property="bpcRev">	
		 <tr>
